...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
	console.log("HOOK registration done successfully")
    if (message.adPlaying) {
     // console.log('Ad detected by YouTube Ad Detector extension!');
      // You can further log this information somewhere if needed
    }
  });
...
var extpay = ExtPay('ad-silencer-skipper-plugin-tool'); 
...
extpay.getUser().then(user => {
	...
	if (user.paid) {
        ...
        console.log("PAID user started using our services")
